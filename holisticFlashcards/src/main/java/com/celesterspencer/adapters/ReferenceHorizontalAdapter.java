...
public class ReferenceHorizontalAdapter extends BaseAdapter{
    private Context mContext;
    private ArrayList<Word> words;
    
    public ReferenceHorizontalAdapter(Context c, ArrayList<Word> words) {
        mContext = c;
        this.words = words;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
    	...
    	if (position == words.size()) {
    	    ...
    	    referenceView = inflater.inflate(R.layout.entry_add_reference, parent, false);
